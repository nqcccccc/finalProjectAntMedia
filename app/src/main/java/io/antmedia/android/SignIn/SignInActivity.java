package io.antmedia.android.SignIn;
...
import io.antmedia.android.SignUp.SignUpActivity;
...
public class SignInActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void forgot(){
        ...
        final EditText txtEmail_forgot = alertLayout.findViewById(R.id.txtEmail_forgot);
        Button btnRequest = alertLayout.findViewById(R.id.btnRequest);
        final ProgressBar progressBar_forgot = alertLayout.findViewById(R.id.progressBar_forgot);
